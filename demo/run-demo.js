...
if (args.includes('--help') || args.includes('-h')) {
    ...
    console.log('  node run-demo.js yaml                    # Run YAML demo with Hugging Face local');
    console.log('  node run-demo.js --format=po             # Run PO demo with Hugging Face local');
    console.log('  node run-demo.js --engine=huggingface    # Run all demos with Hugging Face cloud');
    console.log('  node run-demo.js --engine=openai         # Run all demos with OpenAI');
    console.log('  node run-demo.js json --engine=openai    # Run JSON demo with OpenAI');
    console.log('  node run-demo.js                         # Run all demos with Hugging Face local');
    process.exit(0);
}
