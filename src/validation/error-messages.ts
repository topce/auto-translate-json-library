...
export const errorMessageTemplates: Record<string, ErrorMessageTemplate> = {
  ...
  JSON_CIRCULAR_REFERENCE: {
    ...
    template:
      "JSON data contains circular references that cannot be serialized",
  ...
  JSON_DEEP_NESTING: {
    ...
    description:
      "Excessive nesting can cause performance issues and make the file hard to maintain",
    severity: "warning",
    category: "structure",
    actionable: true,
    suggestion:
      "Consider flattening the structure or breaking it into smaller files",
  },
  ...
  XLIFF_MISSING_VERSION: {
    ...
    description:
      "XLIFF files should specify their version for proper processing",
    severity: "warning",
    category: "metadata",
    actionable: true,
    suggestion:
      'Add version attribute to the XLIFF root element (e.g., version="1.2")',
  },

  XLIFF_INVALID_VERSION: {
    code: "XLIFF_INVALID_VERSION",
    template:
      "Unsupported XLIFF version: {version}. Supported versions are {supportedVersions}",
  ...
  ARB_MISSING_LOCALE: {
    ...
    template:
      "ARB file should contain @@locale metadata to specify the language",
    description:
      "The @@locale metadata helps identify the language of the ARB file",
    severity: "warning",
    category: "metadata",
    actionable: true,
    suggestion:
      'Add "@@locale": "language_code" to the ARB file (e.g., "en", "es_ES")',
  },

  ARB_INVALID_LOCALE: {
    code: "ARB_INVALID_LOCALE",
    template:
      'Invalid locale format: "{locale}". Expected format: language[_COUNTRY]',
    description:
      "Locale codes should follow standard language and country code format",
    severity: "warning",
    category: "metadata",
    actionable: true,
  ...
  ARB_ICU_SYNTAX_ERROR: {
    ...
    description:
      "The ICU message format syntax is invalid and may cause runtime errors",
    severity: "error",
    category: "syntax",
    actionable: true,
    suggestion:
      "Fix the ICU syntax error. Common issues: unmatched brackets, missing commas, invalid placeholders",
    documentation:
  ...
  ARB_ORPHANED_METADATA: {
    ...
    actionable: true,
    suggestion:
      "Either add the missing resource or remove the orphaned metadata",
  },
  ...
  PO_MISSING_HEADER: {
    ...
    description:
      "PO file headers contain important metadata like language, encoding, and plural forms",
    severity: "warning",
    category: "metadata",
    actionable: true,
    suggestion:
      "Add PO file header with Language, Content-Type, and Plural-Forms fields",
  },
  ...
  EMPTY_TRANSLATION_STRING: {
    ...
    actionable: true,
    suggestion:
      "Provide a translation for this string or remove it if not needed",
  },
  ...
  VERY_LONG_STRING: {
    ...
    description:
      "Very long strings may indicate data issues or poor user experience",
    severity: "info",
    category: "content",
    actionable: false,
    suggestion:
      "Consider breaking long text into smaller, more manageable pieces",
  },
  ...
  DUPLICATE_KEYS: {
    ...
    description:
      "Duplicate keys can cause conflicts and unpredictable behavior",
    severity: "error",
    category: "structure",
    actionable: true,
  ...
  KEY_CONTAINS_SPACES: {
    ...
    actionable: true,
    suggestion:
      "Consider using underscores, camelCase, or kebab-case instead of spaces",
  },
  ...
  KEY_SPECIAL_CHARACTERS: {
    ...
    actionable: false,
    suggestion:
      "Consider using only alphanumeric characters, dots, underscores, and dashes",
  },
  ...
  PROPERTIES_UNESCAPED_UNICODE: {
    ...
    description:
      "Properties files may require Unicode escaping for non-ASCII characters",
    severity: "warning",
    category: "format",
    actionable: true,
    suggestion:
      "Use Unicode escapes (\\uXXXX) for non-ASCII characters or ensure UTF-8 encoding",
  },
  ...
  VERY_LARGE_FILE: {
    ...
    description:
      "Large files may take longer to process and consume more memory",
    severity: "warning",
    category: "content",
    actionable: false,
...
export class ErrorMessageFormatter {
   ...
   */
  static registerCustomTemplates(
    templates: Record<string, ErrorMessageTemplate>,
  ): void {
